...
Usage:
    ovf_deploy.rb [options] <vmname> <ovfurl>
    Example: ruby ovf_deploy.rb --computer-path "Flex10Cluster" 
               --host 100.68.106.72 --user administrator@vsphere.local --password P@ssw0rd --no-ssl 
               --network "FlexMan_pg" "Data1_pg" "Data2_pg" --insecure --datacenter "Flex10DC" 
               --datastore "flex11-host1-local-storage-1" svm http://100.68.106.121:8080/svc/repo/scaleio/SVMOVA/ScaleIOVM2.ovf
...
Other options:
  ...
  opt :network, "List of networks to attach template to, strings separated by spaces", :type => :strings
